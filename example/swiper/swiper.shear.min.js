...
shear && shear.register({
    template: '<div sv-register="swiper" class="swiper-container"><div class="swiper-wrapper" sv-content></div></div>',
    attrs: ['autoplay'],
    render: function($this) {
        // 添加相关节点数据
        $this.addClass('swiper-container').css('display', 'block');
        ...
        setTimeout(() => {
            ...
            // 监听autoplay属性
            $this.watch('autoplay', function(a) {
                swiper.params.autoplay = a;
            });
